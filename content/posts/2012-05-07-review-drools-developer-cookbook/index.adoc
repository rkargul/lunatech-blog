...
image:drools-developers-cookbook-cover.jpg[Drools Developer’s Cookbook,link=http://www.packtpub.com/drools-developers-using-jboss-cookbook/book]
...
http://www.packtpub.com/jboss-drools-business-rules/book[JBoss Drools Business Rules] is a much less technical book for business analysts
(that don’t write code) and
http://www.packtpub.com/drools-jboss-rules-50-developers-guide/book[Drools JBoss Rules 5.0 Developer’s Guide] is a shallow overview of the various
...
(link:/2011/09/19/playframework-cookbook-review[Play Framework Cookbook]) apply here too: more typos than I’m used to in a print book,
