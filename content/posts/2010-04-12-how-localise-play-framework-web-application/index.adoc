...
(internationalization, `I18N`) and http://en.wikipedia.org/wiki/Language_localisation[language localisation]
...
Blog Engine' example application, used in the http://www.playframework.org/documentation/1.0.1/guide1[Play tutorial].
...
http://java.sun.com/javase/6/docs/api/java/util/Formatter.html#syntax[Java format string] to insert the parameter value in the message:
...
https://javaserverfaces-spec-public.dev.java.net/issues/show_bug.cgi?id=517[javaserverfaces-spec-public issue 517].
...
French:
link:/confluence/download/attachments/33259831/yabe-l10n-1.0.2.zip?version=1&modificationDate=1270572211397[yabe-l10n-1.0.2.zip]
